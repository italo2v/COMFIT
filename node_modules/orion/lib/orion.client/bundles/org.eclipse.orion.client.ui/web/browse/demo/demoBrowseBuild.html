...
<html>
    <head>
		...
		<title>View Gist File</title>
	    <link rel="stylesheet" type="text/css" href="../built/built-browser.css"/>
		<script src="../built/built-browser.js"></script>
		<script>
		window.onload=function(){
			orion.browse.browser(
				"fileBrowser",
				"https://github.com/libingw/test1.git",
				null /*,
				null ,
				{maxLine: 50, fileURL: "https://api.github.com/repos/libingw/test1/contents!testBranch/demo.html"}*/
			); 
		};
		</script>
    </head>
