...
<head>
	<meta charset="UTF-8">
    <meta name="copyright" content="Copyright (c) IBM Corporation and others 2015.">
	...
	<script type="text/javascript">
		...
		require(["plugins/languageToolsPlugin"]);
	</script>
</head>
...
<body id="orion-settings" class="orionPage" style="padding: 10px;">
	...
	<p>
		This plugin provides tooling for languages that are not included in other core Orion plugins.
	</p>
	<p>October 16, 2013</p>	
