...
<head>
	...
	<script type="text/javascript">
		...
		require(["plugins/languages/arduino/arduinoPlugin"], function(arduinoPlugin) {
			arduinoPlugin.connect();
		});
	</script>
</head>

<body id="orion-settings" class="orionPage" style="padding: 10px;">
	<h2>Arduino Tools Support</h2>
	<p>
		This plugin provides Arduino tooling, including:
	</p>
	<ul>
