...
<head>
	...
	<script type="text/javascript">
		...
		require(["plugins/languages/docker/dockerPlugin"], function(dockerPlugin) {
			dockerPlugin.connect();
		});
	</script>
</head>

<body id="orion-settings" class="orionPage" style="padding: 10px;">
	<h2>Docker Editor Tools Support</h2>
	<p>
		This plugin provides Docker tooling, including:
	</p>
	<ul>
		<li><em>Editing</em> - an editor with syntax highlighting of 'dockerfile' files</li>
	</ul>
	<p>October 16, 2013</p>
