...
<head>
	...
	<script type="text/javascript">
		...
		require(["plugins/languages/markdown/markdownPlugin"], function(markdownPlugin) {
			markdownPlugin.connect();
		});
	</script>
</head>

<body id="orion-settings" class="orionPage" style="padding: 10px;">
	<h2>Extended Markdown Support</h2>
	<p>
		This plugin provides extended Markdown tooling, including:
	</p>
	<ul>
		<li>Content Assist Templates - templates for markdown syntax</li>
	</ul>
	<p>October 16, 2013</p>	
