...
<head>
	...
	<script type="text/javascript">
		...
		require(["plugins/languages/objectiveC/objectiveCPlugin"], function(objectiveCPlugin) {
			objectiveCPlugin.connect();
		});
	</script>
</head>

<body id="orion-settings" class="orionPage" style="padding: 10px;">
	<h2>Objective-C Tools Support</h2>
	<p>
		This plugin provides Objective-C tooling, including:
	</p>
	<ul>
