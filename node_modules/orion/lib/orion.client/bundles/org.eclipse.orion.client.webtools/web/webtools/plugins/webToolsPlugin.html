...
<body>
	<h2>Orion Web Tools Support</h2>
	<p>
		This plug-in provides tools for web languages, including HTML, CSS and Markdown:
	</p>
	<ul>
		<li><em>Editing</em> - an editor with syntax highlighting</li>
		<li><em>Content Assist</em> - completion and templates while editing</li>
		<li><em>Navigation</em> - source navigation and a source outline</li>
	</ul>
	<p>March 27, 2014</p>	
