...
var host = process.env.VCAP_APP_HOST || '0.0.0.0'; //'comfit.labnet.nce.ufrj.br';
var port = process.env.VCAP_APP_PORT || '3000';
var homepage = '/web2compile/'; //web2compile home page
//var homepage = '/edit/edit.html'; //orion home page

var isCloudFoundry = false; //host!=='localhost';
...
if (ENABLE_AUTH) {
	...
	app.use('/web2compile', authentication.ensureAuthenticated);
